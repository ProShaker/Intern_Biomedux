...
class MainUI(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("DuxCycler_ProtoTester - camsetting(for biomedux product)") # set title
...
class ControlFrame(QFrame):
    def __init__(self):
        ...
        # added 231222 for usability
        self.label_remain_time = QLabel('')
        self.label_remain_time.setFixedSize(50, 30)
        self.label_remain_time.setStyleSheet('border: 1px solid black;')
        
        self.label_current_label = QLabel('')
        self.label_current_label.setFixedSize(50, 30)
        self.label_current_label.setStyleSheet('border: 1px solid black;')
        ...
        self.info_layout.addWidget(self.label_remain_time)
        self.info_layout.addWidget(self.label_current_label)
